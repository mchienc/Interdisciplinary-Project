...
('Lotte Mall West Lake Hanoi (Lotte Tây Hồ)', 'shopping', 'Đại siêu thị và tổ hợp mua sắm - giải trí phức hợp hiện đại bậc nhất Thủ đô rộng 354.000m² view Hồ Tây, Thủy cung Lotte World Aquarium và đại lộ thời trang.', 21.0754, 105.8122, 120, '09:30 - 22:00', 0, ST_SetSRID(ST_MakePoint(105.8122, 21.0754), 4326)),
('Tràng Tiền Plaza & Phố Đi Bộ Hồ Gươm', 'shopping', 'Biểu tượng mua sắm xa xỉ và cổ kính nhất Thủ đô từ năm 1901 thời Pháp thuộc, quy tụ thương hiệu quốc tế cao cấp ngay sát bờ Hồ Gươm.', 21.0258, 105.8546, 60, '09:30 - 21:30', 0, ST_SetSRID(ST_MakePoint(105.8546, 21.0258), 4326)),
('Vincom Mega Mall Times City & Thủy Cung', 'shopping', 'Đại trung tâm thương mại ngầm khổng lồ với thủy cung Vinpearl Aquarium, khu vui chơi VinKE và quảng trường nhạc nước.', 20.9950, 105.8677, 120, '10:00 - 22:00', 0, ST_SetSRID(ST_MakePoint(105.8677, 20.9950), 4326)),
('Aeon Mall Long Biên', 'shopping', 'Đại siêu thị mua sắm và giải trí chuẩn phong cách Nhật Bản Omotenashi, ẩm thực phong phú và rạp chiếu phim CGV lớn.', 21.0264, 105.9015, 120, '10:00 - 22:00', 0, ST_SetSRID(ST_MakePoint(105.9015, 21.0264), 4326)),
('Lotte Center Hà Nội (Liễu Giai) & Sky Walk', 'shopping', 'Tòa tháp 65 tầng biểu tượng hiện đại với TTTM Lotte Department Store cao cấp và đài quan sát sàn kính Sky Walk ngắm toàn cảnh Hà Nội 360°.', 21.0333, 105.8130, 90, '09:30 - 22:00', 0, ST_SetSRID(ST_MakePoint(105.8130, 21.0333), 4326));
