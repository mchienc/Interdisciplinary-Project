...
router = APIRouter(prefix="/api/v1", tags=["Urban Spatial Analysis (Legacy)"])

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
DATA_RAW_DIR = os.path.abspath(os.path.join(CURRENT_DIR, "..", "..", "..", "data", "raw"))

AMENITIES_FILE = os.path.join(DATA_RAW_DIR, "hanoi_public_amenities.geojson")
COMMERCIAL_FILE = os.path.join(DATA_RAW_DIR, "hanoi_commercial_centers.geojson")
DISTRICTS_FILE = os.path.join(DATA_RAW_DIR, "hanoi_districts.geojson")

def load_amenities_data():
    target_file = AMENITIES_FILE if os.path.exists(AMENITIES_FILE) else COMMERCIAL_FILE
